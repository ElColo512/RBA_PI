...
namespace RBA_PI.Web.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, ILogger<ChangePasswordModel> logger) : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "La contraseña fue actualizada correctamente.";

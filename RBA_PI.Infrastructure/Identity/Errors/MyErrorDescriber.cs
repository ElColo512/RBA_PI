...
namespace RBA_PI.Infrastructure.Identity.Errors
{
    public class MyErrorDescriber : IdentityErrorDescriber
    {
        public override IdentityError DuplicateEmail(string email)
        {
            return new IdentityError
            {
                ...
                Description = $"Ya existe un usuario con el correo «{email}». Por favor elige otro."
            };
        }
        ...
        public override IdentityError PasswordRequiresNonAlphanumeric()
        {
            return new IdentityError
            {
                ...
                Description = "La contraseña debe contener al menos un carácter no alfanumérico (por ejemplo, un símbolo como @, #, $)."
            };
        }
